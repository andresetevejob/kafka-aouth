...
import org.andre.strimzi.oauth.common.ConfigUtil;
import org.andre.strimzi.oauth.common.TokenInfo;
import org.andre.strimzi.oauth.validator.JWTSignatureValidator;
import org.andre.strimzi.oauth.validator.OAuthIntrospectionValidator;
import org.andre.strimzi.oauth.validator.TokenValidationException;
import org.andre.strimzi.oauth.validator.TokenValidator;
...
import static org.andre.strimzi.oauth.common.JSONUtil.getClaimFromJWT;
import static org.andre.strimzi.oauth.common.LogUtil.mask;
...
public class JaasServerOauthValidatorCallbackHandler implements AuthenticateCallbackHandler {
    ...
    public void configure(Map<String, ?> configs, String saslMechanism, List<AppConfigurationEntry> jaasConfigEntries) {
        ...
        log.info("jwksUri value '"+jwksUri);
        if (jwksUri != null) {
            log.info("certs value '"+jwksUri);
            validator = new JWTSignatureValidator(
                    ...
                    config.getValueAsInt(ServerConfig.OAUTH_JWKS_REFRESH_SECONDS, 60),
                    config.getValueAsInt(ServerConfig.OAUTH_JWKS_EXPIRY_SECONDS, 170),
                    true,
                    null
            );
        } else {
            log.info("token '"+jwksUri);
