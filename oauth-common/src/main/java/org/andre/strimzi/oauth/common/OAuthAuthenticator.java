...
import static org.andre.strimzi.oauth.common.TokenIntrospection.introspectAccessToken;
...
public class OAuthAuthenticator {
    ...
    private static TokenInfo post(URI tokenEndpointUri, SSLSocketFactory socketFactory, HostnameVerifier hostnameVerifier, String authorization, String body) throws IOException, IOException {
